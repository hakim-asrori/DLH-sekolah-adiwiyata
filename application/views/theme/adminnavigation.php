<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SEKOLAH ADIWIYATA</div>
      </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/agenda'?>">
          ...
          <span>Daftar Sekolah Adiwiyata</span></a>
      </li>
    
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/pengumuman'?>">
          <i class="fas fa-fw fa-volume-up"></i>
          <span>Daftar Pengumuman Kegiatan Perlombaan</span></a>
      </li>
    
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/files'?>">
          <i class="fas fa-fw fa-download"></i>
          <span>Kegiatan Sub Koordinator Kemitraan Lingkungan Hidup Di Sekolah</span></a>
      </li>
    <!--<li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/video'?>">
          <i class="fas fa-fw fa-download"></i>
          <span>Data Video Kegiatan / Profil Sekolah Adiwiyata</span></a>
      </li>
    <li class="nav-item">
